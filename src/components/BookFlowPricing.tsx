...
const TIERS: Tier[] = [
  {
    ...
    name: "Solo",
    price: "29,99",
    pitch: "Vous travaillez seul, et vous voulez arrêter de gérer les rendez-vous par téléphone.",
  ...
  },
  {
    ...
    name: "Institut",
    price: "59,99",
    pitch: "Vous êtes plusieurs : chacun son agenda, ses prestations et ses horaires.",
